 ...
 * @author User
 */
public class TestReadReserveWords {
    static File fileName = new File("C://Users//User//Documents//NetBeansProjects//239785_A2//test files//MyThread1.java");
    @Test
    ...
    public void readAssert() {
        ...
        try {
            ...
            try (BufferedReader bufferedReader = new BufferedReader(fileReader)) {
                ...
                System.out.println("No of Package: " + noassert);
                bufferedReader.close();
                // Always close files.
            }
        } catch (FileNotFoundException ex) {
    ...
    public void readint() {
        ...
        }Assert.assertEquals("No of int: 4","No of int: 4");
    }
    ...
    public void readnew() {
        ...
        }Assert.assertEquals("No of new: 1","No of new: 1");
    }
